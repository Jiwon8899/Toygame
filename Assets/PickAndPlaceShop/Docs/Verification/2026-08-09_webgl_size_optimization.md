...
## PART C. 미사용 생성 에셋·패키지 정리

- 80개 상품 래퍼가 원본 GLB를 참조하면서 별도로 복제하던 메시 80개(디스크 1,605.80 MiB)를 제거했다.
- 래퍼는 동일한 원본 GLB 프리팹을 직접 참조하며, 정규화 스케일·빌드 안전 머티리얼·상품 200종 매핑은 유지한다.

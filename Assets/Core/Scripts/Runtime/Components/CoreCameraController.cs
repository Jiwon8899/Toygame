...
namespace Blocks.Gameplay.Core
{
    ...
    public class CoreCameraController : NetworkBehaviour
    {
        ...
        public void SetLookInput(Vector2 lookInput)
        {
            ...
            float verticalInput = m_InvertY ? -lookInput.y : lookInput.y;
            m_CurrentVerticalLookAngle = Mathf.Clamp(m_CurrentVerticalLookAngle - (verticalInput * m_LookSensitivity), -m_VerticalLookLimit, m_VerticalLookLimit);
        }

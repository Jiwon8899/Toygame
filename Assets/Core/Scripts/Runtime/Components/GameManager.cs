...
namespace Blocks.Gameplay.Core
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Session UI is optional for the local single-player flow.
            // Multiplayer Services settings are only required when that integration is enabled.
        ...
        private IEnumerator FadeOutAndDisable()
        {
            ...
            // Some gameplay copies intentionally start without the sample session document attached.
            // In that case UI Toolkit has no root yet, so there is nothing to fade.

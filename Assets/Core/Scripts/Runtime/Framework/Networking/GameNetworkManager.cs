...
namespace Blocks.Gameplay.Core
{
    ...
    public class GameNetworkManager : NetworkManager
    {
        ...
        private void Awake()
        {
            ...
            EnsureBaseNetworkManagerAwake();

            Instance = this;
            DontDestroyOnLoad(gameObject);

            NetworkState = new NetworkStateViewModel();
            NetworkManager.OnDestroying += HandleNetworkManagerDestroying;
            SetFrameRate(targetFrameRate, enableVSync);
        }

        /// <summary>
        /// Netcode's private Awake is hidden by this derived component's Awake. In Player builds the
        /// editor-only OnValidate path cannot initialize Netcode's contextual logger, causing
        /// StartHost/StartClient to throw before transport startup. Invoke the base initialization
        /// exactly when its private logger is still absent.
        /// </summary>
        private void EnsureBaseNetworkManagerAwake()
        {
            const System.Reflection.BindingFlags flags =
                System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic;
            System.Reflection.FieldInfo logField = typeof(NetworkManager).GetField("Log", flags);
            if (logField == null || logField.GetValue(this) != null) return;
            System.Reflection.MethodInfo baseAwake = typeof(NetworkManager).GetMethod("Awake", flags);
        ...
        private void OnDestroy()
        {
            const System.Reflection.BindingFlags flags =
                System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic;
            System.Reflection.MethodInfo baseOnDestroy = typeof(NetworkManager).GetMethod("OnDestroy", flags);
            baseOnDestroy?.Invoke(this, null);
        }
        ...
        /// <summary>
        /// Keeps the UI state in sync when the transport cannot start or fails at runtime.
        /// Netcode performs the transport shutdown; this class only updates its view model.
        /// </summary>
        ...
        /// <summary>
        /// Cleans up project-specific callbacks without declaring another Unity OnDestroy method.
        /// NetworkManager owns its private OnDestroy lifecycle and must run it to release the UDP socket.
        /// </summary>
        private void HandleNetworkManagerDestroying(NetworkManager manager)
        {
            if (manager != this)
            {
                return;

...
namespace Blocks.Gameplay.Core
{
    ...
    public class SoundSystem
    {
        ...
        private bool Play(SoundEmitter soundEmitter, Vector3 position, Transform parent = null)
        {
            ...
            // Scene-based network restarts destroy the previous listener with the player/camera.
            // Refresh the cached transform before the next emitter calculates spatial distance.

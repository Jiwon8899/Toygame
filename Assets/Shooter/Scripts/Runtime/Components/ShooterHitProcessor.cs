...
namespace Blocks.Gameplay.Shooter
{
    public class ShooterHitProcessor : HitProcessor
    {
        ...
        private void CreateDamageNumberVisual(Vector3 position, float damage, bool isAttacker)
        {
            ...
            if (GlobalGameFontApplier.LegacyFont != null)
            {
                textMesh.font = GlobalGameFontApplier.LegacyFont;
                textMesh.GetComponent<Renderer>().sharedMaterial = GlobalGameFontApplier.LegacyFont.material;
            }
